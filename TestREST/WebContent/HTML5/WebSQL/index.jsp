...
<div id="container">
	...
	<input type="text" id="searchJmbg" placeholder="JMBG" /><button id="bJmbg">search</button> <br />
	<input type="text" id="searchIme" placeholder="ime" /><button id="bIme">search</button> <br />
	  ...
	  if(!(window.openDatabase)){
		...
		$("#bJmbg").click(function(e) {
			db.transaction(function (tx) {
				   ...
				   tx.executeSql('SELECT * FROM studenti WHERE jmbg=?', [jmbg], function (tx, results) {
